...
const tools = [
  ...
  {
    title: "BioPlot — AI Plotting",
    description: "Publication-ready bioinformatics plots: Volcano, Heatmap, PCA, ROC, Box Plot, GO Enrichment. Inspired by PlotGDP.",
    href: "/tools/bioplot",
    tag: "New",
    tagColor: "#f97316",
    icon: (
  ...
  {
    title: "Curve Fitting",
    description: "Nonlinear regression with Levenberg-Marquardt. 9 models: dose-response, Michaelis-Menten, Hill, exponential, and more.",
    href: "/tools/curve-fitting",
    tag: "New",
    tagColor: "#f97316",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
