...
const tools = [
  ...
  { title: "AI Figure Generator", description: "Create publication-ready scientific illustrations from text. Cell pathways, mechanisms, graphical abstracts — powered by DALL-E 3.", href: "/tools/figure-gen", tag: "AI", tagColor: "#8b5cf6",
